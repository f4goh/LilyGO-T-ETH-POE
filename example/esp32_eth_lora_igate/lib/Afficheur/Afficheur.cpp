...
frameCount(1),
overlaysCount(1),
display(SSD1306Wire(0x3c, SDA, SCL, GEOMETRY_128_64,I2C_TWO,100000)),
...
cnxError(false)
{
  ...
  xTaskCreatePinnedToCore(Afficheur::marshall, "afficheur", 20000, NULL, 5, &TaskHandle_Aff, 1); // creation de la tache   
 }
...
void Afficheur::setCnxState(bool _ethCnx,bool _aprsIsCnx) {
    ethCnx=_ethCnx;
